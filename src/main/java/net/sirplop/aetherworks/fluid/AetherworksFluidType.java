...
public class AetherworksFluidType extends FluidType {
    ...
    public AetherworksFluidType(Properties properties, FluidInfo info) {
        super(properties);
        RENDER_OVERLAY = new ResourceLocation(Aetherworks.MODID, "textures/overlay/" + info.name + ".png");
        TEXTURE_STILL = new ResourceLocation(Aetherworks.MODID, "block/fluid/" + info.name + "_still");
        TEXTURE_FLOW = new ResourceLocation(Aetherworks.MODID, "block/fluid/" + info.name + "_flow");
        TEXTURE_OVERLAY = new ResourceLocation(Aetherworks.MODID, "block/fluid/" + info.name + "_overlay");
