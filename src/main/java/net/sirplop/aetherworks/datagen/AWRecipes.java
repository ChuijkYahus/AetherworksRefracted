...
public class AWRecipes extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ...
        //metal former
        MetalFormerRecipeBuilder.create(AWRegistry.INGOT_AETHER.get()).domain(Aetherworks.MODID).folder(metalFormerFolder).temperature(2100).craftTime(200).fluid(new FluidStack(AWRegistry.AETHERIUM_GAS.FLUID.get(), FluidAmounts.ingotValue())).input(Ingredient.of(EmbersItemTags.DAWNSTONE_INGOT)).save(consumer);
        MetalFormerRecipeBuilder.create(AWRegistry.GEM_AETHER.get()).domain(Aetherworks.MODID).folder(metalFormerFolder).temperature(2600).craftTime(300).fluid(new FluidStack(AWRegistry.AETHERIUM_GAS.FLUID.get(), FluidAmounts.ingotValue() * 4)).input(Ingredient.of(Items.DIAMOND)).save(consumer);
        MetalFormerRecipeBuilder.create(AWRegistry.GEM_AETHER.get()).id(Aetherworks.MODID, "gem_aether_alt").folder(metalFormerFolder).temperature(2800).craftTime(300).fluid(new FluidStack(AWRegistry.AETHERIUM_GAS.FLUID.get(), FluidAmounts.ingotValue() * 4)).input(Ingredient.of(Items.EMERALD)).save(consumer);
        MetalFormerRecipeBuilder.create(AWRegistry.PLATE_AETHER.get()).domain(Aetherworks.MODID).folder(metalFormerFolder).temperature(2400).craftTime(250).fluid(new FluidStack(AWRegistry.AETHERIUM_GAS.FLUID.get(), FluidAmounts.ingotValue() * 2)).input(Ingredient.of(EmbersItemTags.DAWNSTONE_PLATE)).save(consumer);

        ItemStack moonfireGemStack = new ItemStack(AWRegistry.POTION_GEM.get());
        PotionGemItem.setEffectsForRecipe(List.of(new MobEffectInstance(AWRegistry.EFFECT_MOONFIRE.get(), 200, 0, true, true)), moonfireGemStack, Utils.AETHERIUM_PROJECTILE_COLOR.getRGB()); //block amount is ingot * 9
        MetalFormerRecipeBuilder.create(moonfireGemStack).id(Aetherworks.MODID, "moongaze_gem").folder(metalFormerFolder).temperature(2400).craftTime(600).fluid(new FluidStack(AWRegistry.AETHERIUM_GAS.FLUID.get(), FluidAmounts.ingotValue() * 9)).input(Ingredient.of(AWRegistry.POTION_GEM.get())).mustMatchExactly().save(consumer);

        MetalFormerRecipeBuilder.create(AWRegistry.GLASS_AETHERIUM.get().asItem()).domain(Aetherworks.MODID).folder(metalFormerFolder).temperature(2550).craftTime(30).fluid(new FluidStack(AWRegistry.AETHERIUM_GAS.FLUID.get(), FluidAmounts.nuggetValue())).input(Ingredient.of(Blocks.GLASS)).save(consumer);
        ...
        //stamping
        StampingRecipeBuilder.create(AWRegistry.AETHER_SHARD.get()).domain(Aetherworks.MODID).folder(EmbersRecipes.stampingFolder).stamp(RegistryManager.FLAT_STAMP.get()).fluid(AWRegistry.AETHERIUM_GAS_IMPURE.FLUID.get(), FluidAmounts.nuggetValue()).save(ConsumerWrapperBuilder.wrap().build(consumer));
        StampingRecipeBuilder.create(AWRegistry.FOCUS_CRYSTAL.get()).domain(Aetherworks.MODID).folder(EmbersRecipes.stampingFolder).stamp(RegistryManager.FLAT_STAMP.get()).input(AWRegistry.GEM_AETHER.get()).fluid(AWRegistry.ALCHEMIC_PRECURSOR.FLUID.get(), FluidAmounts.ingotValue()).save(ConsumerWrapperBuilder.wrap().build(consumer));
        ...
        //mixing
        MixingRecipeBuilder.create(new FluidStack(AWRegistry.ALCHEMIC_PRECURSOR.FLUID.get(), FluidAmounts.nuggetValue())).domain(Aetherworks.MODID).folder(EmbersRecipes.mixingFolder).input(FluidIngredient.of(EmbersFluidTags.MOLTEN_GOLD, ceilToInt(FluidAmounts.nuggetValue() * 0.4))).input(FluidIngredient.of(EmbersFluidTags.MOLTEN_LEAD, ceilToInt(FluidAmounts.nuggetValue() * 0.4))).input(FluidIngredient.of(RegistryManager.DWARVEN_OIL.FLUID.get(), ceilToInt(FluidAmounts.nuggetValue() * 0.2))).save(ConsumerWrapperBuilder.wrap().build(consumer));
        MixingRecipeBuilder.create(new FluidStack(AWRegistry.AETHERIUM_GAS.FLUID.get(), ceilToInt(FluidAmounts.nuggetValue() * 0.3))).domain(Aetherworks.MODID).folder(EmbersRecipes.mixingFolder).input(FluidIngredient.of(AWRegistry.AETHERIUM_GAS_IMPURE.FLUID.get(), ceilToInt(FluidAmounts.nuggetValue() * 0.4))).input(FluidIngredient.of(AWRegistry.ALCHEMIC_PRECURSOR.FLUID.get(), ceilToInt(FluidAmounts.nuggetValue() * 0.3))).save(ConsumerWrapperBuilder.wrap().build(consumer));

        //melting
        MeltingRecipeBuilder.create(AWRegistry.AETHER_SHARD.get()).domain(Aetherworks.MODID).folder(EmbersRecipes.meltingFolder).output(new FluidStack(AWRegistry.AETHERIUM_GAS_IMPURE.FLUID.get(), FluidAmounts.nuggetValue())).save(ConsumerWrapperBuilder.wrap().build(consumer));
        MeltingRecipeBuilder.create(AWRegistry.AETHERIUM_SHARD_BLOCK.get().asItem()).domain(Aetherworks.MODID).folder(EmbersRecipes.meltingFolder).output(new FluidStack(AWRegistry.AETHERIUM_GAS_IMPURE.FLUID.get(), FluidAmounts.ingotValue())).save(ConsumerWrapperBuilder.wrap().build(consumer));
